  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className={`relative z-10 w-full max-w-5xl ${gameWon ? 'bg-[repeating-linear-gradient(45deg,#ef4444,#ef4444_20px,#dc2626_20px,#dc2626_40px)] shadow-[0_0_50px_rgba(234,179,8,0.5)] border-yellow-400' : 'bg-[repeating-linear-gradient(45deg,#d1d5db,#d1d5db_20px,#9ca3af_20px,#9ca3af_40px)] shadow-[0_0_50px_rgba(156,163,175,0.5)] border-gray-400'} rounded-3xl p-2 lg:p-3 border-4 lg:border-8 flex flex-col mt-4 md:mt-0`}
      >
        <div className={`absolute inset-0 border-[4px] lg:border-[6px] border-dotted ${gameWon ? 'border-yellow-200' : 'border-gray-200'} rounded-2xl opacity-80 pointer-events-none`}></div>

        <div className={`bg-white rounded-2xl w-full h-full z-10 relative border-2 lg:border-4 ${gameWon ? 'border-yellow-300' : 'border-gray-300'} shadow-inner overflow-hidden`}>
          {/* Header */}
          <div className={`py-4 lg:py-6 px-4 text-center ${gameWon ? 'bg-gradient-to-r from-yellow-300 to-yellow-500 border-b-4 border-yellow-600' : 'bg-gradient-to-r from-gray-300 to-gray-400 border-b-4 border-gray-500'}`}>
            <h1 className={`text-3xl lg:text-5xl font-black ${gameWon ? 'text-red-600' : 'text-gray-800'} tracking-wide drop-shadow-sm uppercase font-sans`}>
              {gameWon ? "🎪 Congratulations! You Won! 🎪" : "🎪 Thank You for Playing! 🎪"}
            </h1>
          </div>
          ...
          {gameWon ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 w-full">
              ...
              <div className="bg-orange-50 rounded-2xl p-6 border-2 border-orange-200 flex flex-col items-center text-center">
                <h3 className="text-xl font-black text-orange-800 mb-6">AJobThing Voucher</h3>
                <div className="flex flex-col items-center">
                  <img src="https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-32b78986-c8d5-48e2-997b-7b1ca52460fd.png" className="h-40 object-contain drop-shadow-lg" alt="AJobThing Voucher" />
                  <span className="text-lg font-bold text-orange-900 mt-4">Up to RM477 OFF</span>
                  <span className="text-sm text-gray-500 mt-2 font-bold">(Valid until 7 July 2026)</span>
                </div>
              </div>

              {/* TnGo */}
              <div className="bg-blue-50 rounded-2xl p-6 border-2 border-blue-200 flex flex-col items-center text-center">
                <h3 className="text-xl font-black text-blue-800 mb-6">1 Ticket to Join Lucky Draw</h3>
                <div className="flex flex-col items-center justify-center flex-1 relative w-full h-full">
                  <div className="relative flex flex-col items-center">
                    ...
                    <img 
                      ...
                      alt="TnGo Lucky Draw" 
                    />
                    <span className="text-sm font-bold text-gray-600 mt-4 px-4 py-2 bg-white rounded-lg shadow-sm">Winners will be announced on 7 July 2026</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-4xl bg-gray-50 rounded-2xl p-4 lg:p-6 border-2 border-gray-200 flex flex-col md:flex-row items-center justify-between text-center md:text-left gap-6 lg:gap-8 mx-auto">
              <div className="flex flex-col items-center justify-center shrink-0">
                <h3 className="text-xl font-black text-gray-800 mb-2">1 Free Internship Job Ad</h3>
                <img src="https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-597cc0ba-7ed7-49b6-acc7-4c28650f79ad.png" className="h-28 lg:h-32 object-contain drop-shadow-lg" alt="Free Internship Job Ad" />
              </div>
              
              <div className="flex flex-col items-center md:items-start gap-4 w-full">
                <span className="text-sm lg:text-base text-gray-700 font-bold bg-white px-6 py-4 rounded-xl border border-gray-200 shadow-sm w-full">Free Intern Job Ad will be assigned to your account. Login and post job now before expired in 7 days.</span>
              ...
              {tngoExpired ? (
                ...
                <>
                  <div className="w-full bg-blue-50 rounded-xl p-4 flex items-center justify-center border-2 border-blue-200 mb-4 h-[200px]">
                    <img src="https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-01b86c06-deab-4dd3-9d33-72439db4f85d.png" className="w-32 h-32 object-cover rounded-full shadow-inner" alt="TnGO QR Placehoder" />
                  </div>
