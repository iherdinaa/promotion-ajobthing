...
const games = [
  { date: 30, month: 5, name: "Emoji Jackpot", img: "https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-18905397-0913-40af-a82a-a4204a032201.png" },
  { date: 1, month: 6, name: "Plinko Board", img: "https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-990f9c6b-9eec-42b2-b6a1-4ea72223901e.png" },
  { date: 2, month: 6, name: "Score Goal", img: "https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-e7e04fbe-4b3d-4636-9a16-99056ca20706.png" },
  { date: 3, month: 6, name: "Ring Toss", img: "https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-7d116e58-f654-4df7-9683-cebd06ffca0b.png" },
  { date: 6, month: 6, name: "Pop Up Ballon", img: "https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-123e7d29-1dca-4cc3-8a10-9af721a8538d.png" },
  { date: 7, month: 6, name: "Throw Dart", img: "https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-49e99ff6-2602-4fa2-9eec-6cba367ef3e5.png" }
];

export default function Game({ onComplete }: GameProps) {
  const [gameState, setGameState] = useState<'selection' | 'jackpot' | 'result'>('selection');
  ...
  return (
    <div 
      ...
      style={{ 
        backgroundImage: `url('https://s3-ap-southeast-1.amazonaws.com/ricebowl/images/marketing-campaign/image-2b000396-7176-43c9-8b42-d478d8d9aa6d.jpg')`
      }}
    >
        ...
        <div className="relative z-10 w-full max-w-5xl mt-10 mb-8 flex flex-col items-center">
          ...
          <div className="w-full bg-[repeating-linear-gradient(45deg,rgba(239,68,68,0.2),rgba(239,68,68,0.2)_20px,rgba(255,255,255,0.1)_20px,rgba(255,255,255,0.1)_40px)] backdrop-blur-xl rounded-3xl p-4 lg:p-8 shadow-[0_0_40px_rgba(234,179,8,0.3)] border-4 border-yellow-400 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {games.map((g, i) => {
                const isActive = g.date === currentDay && g.month === currentMonth;
                const displayActive = isActive || (currentDay === 30 && currentMonth === 5 && i === 0);
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`font-bold px-4 py-1.5 rounded-full text-xs mb-6 uppercase tracking-widest shadow-md z-10 ${
                      displayActive ? 'bg-red-600 text-yellow-300' : 'bg-gray-500 text-white'
                    }`}>
                      {g.date} {g.month === 5 ? 'June' : 'July'} 2026
                    </div>
                    
                    <div className="h-32 flex items-center justify-center mb-4 z-10">
                      <img src={g.img} className="max-h-full object-contain drop-shadow-xl" alt={g.name} />
                    </div>
        ...
        <div className="relative z-10 w-full max-w-4xl h-screen flex flex-col items-center justify-center p-2 lg:p-4">
          ...
          >
            ...
            <div className="bg-white rounded-2xl p-3 lg:p-6 w-full h-full z-10 relative border-2 lg:border-4 border-yellow-300 shadow-inner flex flex-col justify-between">
              <h2 className="text-2xl lg:text-4xl font-black text-red-600 mb-2 lg:mb-4 drop-shadow-sm uppercase tracking-wider font-sans">🎪 Emoji Jackpot 🎪</h2>
              ...
              {!isSpinning && (
                ...
                >
                  <div className="bg-gradient-to-br from-yellow-100 to-yellow-300 border-2 lg:border-4 border-dashed border-red-500 p-3 lg:p-4 rounded-xl lg:rounded-2xl w-full mb-3 lg:mb-6 shadow-lg shrink-0">
                    <p className="text-lg lg:text-xl font-black text-red-600 mb-1 lg:mb-2 uppercase tracking-wide font-sans">⭐ Hint ⭐</p>
                    <p className="text-gray-900 font-bold text-sm lg:text-lg leading-snug font-sans">A feature to let HRs and Employers send messages to candidates in AJobThing.</p>
                  </div>
      ...
      {gameState === 'result' && (
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-50 backdrop-blur-sm px-4">
          ...
          >
            {gameResult ? (
              <>
                <h2 className="text-3xl font-black text-green-500 mb-2 leading-tight">Correct!</h2>
                <p className="text-lg text-gray-700 font-bold mb-6">You got the right answer!</p>
                <div className="text-6xl mb-6">🎉</div>
              </>
            ) : (
              <>
                <h2 className="text-3xl font-black text-red-500 mb-2 leading-tight">Oops!</h2>
                <p className="text-lg text-gray-700 font-bold mb-6">The correct answer is AJobThing Chat. However, you can still enjoy the reward. Claim now.</p>
                <div className="text-6xl mb-6">🎁</div>
              </>
            )}
